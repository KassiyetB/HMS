  ...
  return (
    <div className="page">
      ...
      <div className="stat-row">
        <StatCard label={kz.patients.total}      value={stats?.total      ?? '—'} sub={kz.dashboard.admitted} color="var(--accent)" />
        <StatCard label={kz.status.critical}      value={stats?.critical   ?? '—'} sub={kz.dashboard.needsAttention} color="var(--red)" />
